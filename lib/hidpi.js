...
function hidpi(canvas) {
    if (typeof window == 'undefined')
        return;
    if (processedCanvasMap.has(canvas))
        return;
...
exports.hidpi = hidpi;
function getContext(type, option) {
    if (type == '2d') {
...
function processContext(context) {
    ...
    context.fillText = function () {
        this.font = this.font.replace(/(\d+)(px|em|rem|pt)/g, (w, m, u) => m * pixelRatio + u);
